...
FlatUiControl::FlatUiControl(QWidget *parent) : QWidget(parent)
{

}

QString FlatUiControl::setPushButtonQss(QPushButton *btn, int radius, int padding,
...
QString FlatUiControl::setLineEditQss(QLineEdit *txt, int radius, int borderWidth,
                                      const QString &normalColor,
...
QString FlatUiControl::setProgressQss(QProgressBar *bar, int barHeight,
...
QString FlatUiControl::setSliderQss(QSlider *slider, int sliderHeight,
                                    const QString &normalColor,
...
QString FlatUiControl::setRadioButtonQss(QRadioButton *rbtn, int indicatorRadius,
        const QString &normalColor,
...
QString FlatUiControl::setScrollBarQss(QWidget *scroll, int radius, int min, int max,
